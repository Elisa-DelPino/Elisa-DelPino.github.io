...
function injectProcedureCSS() {
  ...
  style.textContent = `
    ...
    .procedure__heading {
      width: auto;
      margin: 0 calc(-1 * clamp(20px, 3vw, 42px)) clamp(40px, 5vw, 65px);
      display: flex;
      align-items: center;
    ...
    .procedure__lineProgress {
      ...
      box-shadow: 0 0 4px rgba(196, 92, 255, 1), 0 0 10px rgba(162, 64, 223, 0.8), 0 0 20px rgba(162, 64, 223, 0.35);
    ...
    .procedure__axis.is-complete .procedure__arrow {
      border-color: #c45cff;
      filter: drop-shadow(0 0 7px rgba(162, 64, 223, 0.95));
    }
    ...
    .procedure__card {
      ...
      justify-content: center;
      background: radial-gradient(circle at 50% 0%, rgba(255, 255, 255, 0.035), transparent 45%), #050507;
      border: 1px solid rgba(255, 255, 255, 0.55);
      border-radius: clamp(6px, 0.7vw, 10px);
      box-shadow: 0 0 6px rgba(255, 255, 255, 0.05), inset 0 0 18px rgba(255, 255, 255, 0.015);
      overflow: hidden;
    ...
    .procedure__card::before {
      ...
      width: 65%;
      height: 190%;
      background: linear-gradient(105deg, transparent, rgba(196, 92, 255, 0.16), transparent);
    ...
    .procedure__step.is-active .procedure__card {
      border-color: rgba(196, 92, 255, 1);
      background: radial-gradient(circle at 50% 0%, rgba(162, 64, 223, 0.15), transparent 50%), #07070a;
      box-shadow: 0 0 6px rgba(196, 92, 255, 0.95), 0 0 18px rgba(162, 64, 223, 0.42), 0 0 34px rgba(162, 64, 223, 0.13), inset 0 0 23px rgba(162, 64, 223, 0.09);
    }
    ...
    .procedure__icon {
      ...
      box-shadow: 0 0 7px rgba(162, 64, 223, 0.18);
    ...
    .procedure__step.is-active .procedure__icon {
      color: #c45cff;
      border-color: #c45cff;
      box-shadow: 0 0 7px rgba(196, 92, 255, 0.8), 0 0 15px rgba(162, 64, 223, 0.35);
    }
    ...
    .procedure__step.is-active .procedure__connector {
      background: #a240df;
      box-shadow: 0 0 8px rgba(162, 64, 223, 0.75);
    }

    .procedure__step.is-active .procedure__marker {
      border-color: #c45cff;
      transform: translateX(-50%) scale(1.15);
      box-shadow: 0 0 5px rgba(196, 92, 255, 1), 0 0 14px rgba(162, 64, 223, 0.75);
    }
    ...
    @media (hover: hover) and (pointer: fine) {
      ...
      .procedure__step:hover .procedure__card {
        border-color: rgba(196, 92, 255, 1);
        box-shadow: 0 0 6px rgba(196, 92, 255, 0.9), 0 0 18px rgba(162, 64, 223, 0.38), inset 0 0 22px rgba(162, 64, 223, 0.08);
      }
    }
    ...
    @media screen and (max-width: 1000px) {
      .procedure {
        width: var(--w-container-size);
        height: auto;
        padding: clamp(45px, 7vw, 65px) clamp(12px, 3vw, 25px) clamp(40px, 7vw, 60px);
        overflow: hidden;
      }
      ...
      .procedure__heading {
        margin: 0 calc(-1 * clamp(12px, 3vw, 25px)) clamp(35px, 7vw, 55px);
      }
      ...
      .procedure__axis.is-complete .procedure__arrow {
        border-right-color: #c45cff;
        border-bottom-color: #c45cff;
      }
